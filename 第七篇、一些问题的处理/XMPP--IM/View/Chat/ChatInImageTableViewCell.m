...
@interface ChatInImageTableViewCell()<MWPhotoBrowserDelegate>
...
@implementation ChatInImageTableViewCell
...
- (void)awakeFromNib {
    ...
    self.contentImageView.contentMode = UIViewContentModeLeft;
