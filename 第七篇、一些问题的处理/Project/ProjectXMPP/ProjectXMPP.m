...
- (void)sendTextMessage:(NSString *)text toFriend:(XMPPJID *)friendJID {
    ...
    XMPPMessage *message = [XMPPMessage messageWithType:@"normal" to:friendJID];
...
//                                  @"msgId":@"11",
//                                  @"content":@"https://gss2.bdstatic.com/-fo3dSag_xI4khGkpoWK1HF6hhy/baike/c0%3Dbaike150%2C5%2C5%2C150%2C50/sign=44130f826d63f62408503151e62d809d/902397dda144ad34ef8e033cd6a20cf431ad855c.jpg",
//                                  @"fromUser":[UserModel currentUser].jid.user,
//                                  @"toUser":friendJID.user,
//                                  };
//    // 消息体
//    [message addBody:[self convertToJsonData:messageDict]];
//    // 发送消息
//    [self.stream sendElement:message];
}
// 字典转json字符串方法
...
- (void)getOfflineMessageConfiguration {
    ...
    XMPPJID *jid = [UserModel currentUser].jid;
//    NSString *jidString = [NSString stringWithFormat:@"%@@%@/%@", [UserModel currentUser].jid.user, kDomainName, kResource];
